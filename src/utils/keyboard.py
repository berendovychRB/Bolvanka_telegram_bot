...
menu = ReplyKeyboardMarkup(resize_keyboard=True).add(btnAllFilms, btnReviewedFilms, btnUnreviewedFilms, btnAddFilm)
...
# """***************************** InlineMenu ****************************"""
btnDelete = InlineKeyboardButton(f"{languages[d_lan]['delete']}", callback_data="delete")
btnReviewed = InlineKeyboardButton(f"{languages[d_lan]['reviewed']}", callback_data="reviewed")
